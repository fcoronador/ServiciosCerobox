...
### Compila y minifies para producción
```
npm run build
```

## Instalación local de backend
...
3. Configure su archivo `.env` con los datos de acceso local a la base de datos de la siguiente manera usando el nombre de base de datos `mydb` o la deseada:
